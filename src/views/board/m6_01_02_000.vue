<template>
    <div class="rowBox">
        ...
        <div class="unitBox">                        
            <div class="titArea">
                <h2 class="tit l">공지사항<em>AIDU 관련 공지사항을 알려드립니다.</em></h2>
            </div>
            <div class="rowTable">
                <table>
                    <colgroup>
                ...
                <div class="btnArea mgT10 txtRight">
                    <router-link tag="button" to="/board/notice/list" class="btn l cGreen w100px"><span class="text">목록</span></router-link>
                </div>
            </div>
        </div>
        <div class="unitBox">
