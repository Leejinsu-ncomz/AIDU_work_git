    ...
    <div class="rowBox">
        <div class="unitBox">
            <div class="locationWrap">
                <ul class="location">
                    <li><a href="javascript:void(0)">자유게시판</a></li>
        ...
        <div class="unitBox">                        
            <div class="titArea">
                <h2 class="tit l">자유게시판<em>AIDU 사용에 대한 자유로운 의견을 나누세요.</em></h2>
            </div>
            <div class="rowTable">
                <table>
                    <colgroup>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>Sample.zip<em class="pColor02">(123 kb)</em></td>
                            <th scope="row">조회수</th>
                            <td >93</td>
                        </tr>
                    </tbody>
                </table>
                <div class="contentTxtWrap">
                    <div class="contentTxtBox">
                        <span class="contentTxt"></span>
                    </div>
                </div>
                <div class="btnArea mgT10 txtRight rowBoxBtnArea">
                    <router-link tag="button" to="/board/free/edit" class="btn l cGrayGreen w100px"><span class="text">수정</span></router-link>
                    <button type="button" class="btn l cGrayGreen w100px" @click="fnOpen('modal-1')"><span class="text">삭제</span></button>
                    <router-link tag="button" to="/board/free/list" class="btn l cGreen w100px"><span class="text">목록</span></router-link>
                </div>
            </div>
        </div>
        ...
        <div class="layerModalWrap" v-if="modalShow === 'modal-1'">            
            <div class="layerModal conAlertModal">
                ...
                <div class="modalCnt">
                    <p class="text txtCenter">해당 글을 삭제 하시겠습니까?</p>
                </div>
