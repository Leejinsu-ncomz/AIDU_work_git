  ...
  <div class="rowBox">
    ...
    <div class="unitBox mgT30">
      <div class="titArea">
        <div class="tit">
          데이터 관리<em
            >PC에 있는 데이터를 분석을 위해 업로드 할 수 있습니다.</em
          >
        </div>
        <div class=""></div>
      </div>
              ...
              <dl class="unit">
                ...
                <dd>
                  <textarea
                    class="inp"
                    style="height: 170px"
                    placeholder="언제 어디서나 AIDU를 통해 AI 모델을 만들어보세요."
                  ></textarea>
                </dd>
              </dl>
              <dl class="unit">
    ...
    <div class="layerModalWrap" v-if="modalShow === 'modal-3'">
      <div class="layerModal">
        <div class="modalHeader">
          <strong>프로젝트 맴버 추가</strong>
        </div>
    ...
    <!-- PC파일 업로드 팝업-->
    <div class="layerModalWrap" v-if="modalShow === 'modal-4'">
      <div class="layerModal">
        <div class="modalHeader">
        ...
        <div class="modalCnt">
          <p class="text">
            AIDU 시스템에 업로드 하는 파일의 개인정보는 모두 제거되어야 하며,
            개인정보 이슈로 인한 책임은 업로드 한 본인에게 있습니다.
          </p>
          <img
            class="infoImg"
            src="@/assets/images/img_fileUpload.jpg"
            alt="PC파일 업로드 이미지"
          />
          <div class="inpGroup">
            <input
                    ...
                    <ul class="fileList" ref="fileList" v-if="multipleFiles">
                      <li v-for="(li, index) in list" :key="index">
                        {{ li.text
                          ...
                          type="button"
                          class="btn round cGrayDark onlyIcon fileDelete"
                        >
                          <span class="text">삭제</span>
                        </button>
                      </li>
